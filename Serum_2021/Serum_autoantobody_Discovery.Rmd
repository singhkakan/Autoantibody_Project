...
```{r Heatmap final , fig.height=12, fig.width=7, message=FALSE, warning=FALSE, paged.print=FALSE}
###### Heatmap of normalized data
...
```{r 8 weeks comparison, message=FALSE, warning=FALSE, paged.print=FALSE}
