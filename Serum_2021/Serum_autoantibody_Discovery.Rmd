...
abline(0,1)
topTable(fit.cont,number=30,adjust="BH", p.value=0.05)
...
hits <- colnames(Y)[1:26] #change only colnames so figure headings are meaningful
...
for (i in 1:26){
   ...
   p<- ggplot(Y, aes(x=Strain, y=Y[,i])) +
     ...
     scale_fill_aaas() +
      ...
      theme_minimal() +
      chart_design +
         ylab("Log2 Norm Intensity")  + ylim(5.5,24.5) +
