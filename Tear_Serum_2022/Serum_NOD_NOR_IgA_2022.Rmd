...
IgA_raw$NSI <- as.matrix(IgA_NSI[which(IgA_SNR$med>3),])
IgA_raw$SNR <- as.matrix(IgA_SNR[which(IgA_SNR$med>3),])[,1:15]
```
...
v <- voom(counts=(IgA_raw$NSI*IgA_raw$SNR + 0.5)[,-1], design, plot=TRUE, normalize="quantile")
