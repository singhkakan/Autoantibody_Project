...
### Limma Based Default Normalization & DE Analysis
...
### Results Table: Limma-Voom (Quantile) Normalized DE 
...
#### Combined Boxplots of Upregulated hits 
...
#### Total tear IgG total IgA intensity values. 
```{r}
...
#### Chunk for plotting IgG vs IgA secondary control for each of the samples
...
### Tear IgG vs IgA Correlation Analysis #########
...
```{r Plot for BALB/c, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
### Plot for BALB/c
setwd("~/Documents/3_Parkinsons_disease/Autoantibody_Data/Tear_Auto_Validation_2022")
...
There is a need to normalize the x and y axes. In the next plot, we run correlation on log10 normalized NSI for IgG and IgA.
...
####"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"###
####"Old-new-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#October 2024#
...
#### Scatterplot of shared epitopes between upregulated IgG and IgA autoantibodies 
